...
namespace :obtener_datos do
	...
	task obtener_productos_unimarc: :environment do
		...
		desc "obtener productos de prueba"
	task obtener_productos_prueba: :environment do

		begin

			supermercado = Supermercado.new
			supermercado.nombre = "Tottus"
			supermercado.save
	...
	task obtener_productos_lider: :environment do

		data = Mechanize.new { |agent|
		  a.read_timeout = 20
  		a.max_history = 1
		}

		data.get("http://www.lider.cl/walmart/catalog/category.jsp?id=CF_Nivel2_000012&pId=CF_Nivel1_000003&navAction=jump&navCount=0#categoryCategory=CF_Nivel2_000012&pageSizeCategory=20&currentPageCategory=1&currentGroupCategory=1&orderByCategory=lowestPrice&lowerLimitCategory=0&upperLimitCategory=0&&685")
		debugger
